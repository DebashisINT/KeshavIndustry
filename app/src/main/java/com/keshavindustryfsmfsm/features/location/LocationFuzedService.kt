package com.keshavindustryfsmfsm.features.location
...
import com.keshavindustryfsmfsm.app.utils.AppUtils.Companion.getDateTimeFromTimeStamp
import com.keshavindustryfsmfsm.app.utils.AppUtils.Companion.isLocationActivityUpdating
...
import com.keshavindustryfsmfsm.base.presentation.BaseActivity.Companion.isMeetingUpdating
import com.keshavindustryfsmfsm.base.presentation.BaseActivity.Companion.isShopActivityUpdating
import com.keshavindustryfsmfsm.features.addshop.api.AddShopRepositoryProvider
import com.keshavindustryfsmfsm.features.addshop.model.AddShopRequestCompetetorImg
...
import com.keshavindustryfsmfsm.features.dashboard.presentation.SystemEventReceiver
...
import com.keshavindustryfsmfsm.features.gpsstatus.GpsReceiver
import com.keshavindustryfsmfsm.features.gpsstatus.LocationCallBack
import com.keshavindustryfsmfsm.features.location.LocationWizard.Companion.NEARBY_RADIUS
import com.keshavindustryfsmfsm.features.location.api.LocationRepoProvider
import com.keshavindustryfsmfsm.features.location.ideallocapi.IdealLocationRepoProvider
...
//        trackDeviceMemory()
        ...
        //accuracy=1f
        println("distance_loc_tag maxDist : ${AppUtils.maxDistance.toString()} accuracy : {${Pref.minAccuracy.toString()}} " +
                " loc accuracy : ${location.accuracy} lat: ${location.latitude.toString()} lon: ${location.longitude.toString()}")
       ...
       // mantis 25637
        ...
        try{
            ...
            if (locList != null && locList.isNotEmpty()) {
                ...
                println("tag_x_dist diffInMin: $diffInMin  location.distance ${location.distance}")
                ...
                if(diffInMin<3 && location.distance.toDouble().toInt()>8){
                    ...
                    println("tag_x_dist inside if diffInMin: $diffInMin  location.distance ${location.distance}")
                }
                //mantis id 27172 end
            }
        }catch (ex:Exception){
